...
public class HeroKnight : MonoBehaviour {
    ...
    [SerializeField] private AudioClip collectGem;
    ...
    [SerializeField] GameObject hasSphereOn;
    ...
    void Update()
    {
        ...
        if (isOnLadder && Mathf.Abs(inputY)>0f)
        {
            isClimbing = true; 
        }
        ...
        else if(Input.GetMouseButtonDown(0) )
        {
            ...
            {
                enemy.GetComponent<EnemyBehavious>().TakeDamage(attackDamage);
            }
        ...
        //Jump
        else if (Input.GetKeyDown("space") && isOnGround==true)
        {
    ...
    private void FixedUpdate()
    {
        ...
        if (isClimbing)
        {
            ...
            m_body2d.AddForce(Vector3.up * 20f * inputY);
        }
        else
        {
    ...
    private void OnCollisionEnter2D(Collision2D other)
    {
        if (other.gameObject.CompareTag("Princess"))
        {
            ...
            if (other.gameObject.CompareTag("Gate") && hasKey)
        {
            Destroy(other.gameObject);
            hasKey = false;
            hasSphereOn.SetActive(false);
        }
    ...
    public void GameOver()
    {
        ...
        playerAudio.PlayOneShot(playerDie, 1.0f);
    }
